...
python3 upf.py core.log --start-time  17:59:34.505103      --relative-time > upf.txt

python3 async.py iperf3_dscp_100cycles_dl.log --start-time 22:50:26.351730   --relative-time > async.txt

grep "MAC-THP-DL" gnb.log | grep "UE0" > mac.log
python3 mac.py mac.log --start-time 08:59:34.505103 --bin-ms 50 --relative-time > mac.txt


grep "UE0 Throughput calc" gnb.log > thro.log
grep 'UE0 Throughput 1ms' gnb.log > thro.log
python3 thro.py thro.log --start-time 07:58:27.777000   --bin-ms 50 --relative-time > thro.txt

grep "RLC-QUEUE-DELAY" gnb.log | grep "ue=0" > delay.log
python3 delay.py delay.log --relative-time --start-time 08:59:34.505103   > delay.txt
