...
GBR_SENSOR_DL=${GBR_SENSOR_DL:-7000000}
GBR_SENSOR_UL=${GBR_SENSOR_UL:-7000000}
GBR_REMOTE_CTRL_DL=${GBR_REMOTE_CTRL_DL:-5000000}
GBR_REMOTE_CTRL_UL=${GBR_REMOTE_CTRL_UL:-5000000}

# 트래픽
UE0_UDP_RATE=${UE0_UDP_RATE:-10M}
