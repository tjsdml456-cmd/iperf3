...
echo "=== 1단계: UE에서 iperf3 서버 시작 (양방향 수신용) ==="
...
echo "→ UE1 (10.45.0.2): DSCP=46 ( 0xB8)"

iperf3 -c 10.45.0.2 --bidir  -u -b 5M -t 30 -p 6500 -i 1 -S 0xB0 &



echo "→ UE2 (10.45.0.3): DSCP=26 ( 0xB8)"

iperf3 -c 10.45.0.3 --bidir -u -b 5M -t 30 -p 6501 -i 1 -S 0x68 &



echo "→ UE3 (10.45.0.4): DSCP=8 ( 0x88)"

iperf3 -c 10.45.0.4 --bidir -u -b 5M -t 30 -p 6502 -i 1 -S 0x20 &
